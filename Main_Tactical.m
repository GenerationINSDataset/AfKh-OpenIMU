...
wib(:,t) = wib(:,t) + randn(3,1)*4.85e-7 + randn(3,1)*1.745e-4; 

fb(1:2,t) = fb(1:2,t) + (randn(2,1)*9.81e-7 + randn(2,1)*9.81e-7)*g0;

fb(3,t) = fb(3,t) + (randn(1,1)*9.81e-6 + randn(1,1)*9.81e-6)*g0; 
...
RMSEn
RMSEu
save('donnees_TAC.mat', 'p_e_ins', 'p_n_ins', 'p_u_ins')
